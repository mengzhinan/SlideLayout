 ...
 */
public class RecycleViewLineDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public RecycleViewLineDivider(Context context, int orientation, int drawableId) {
     ...
     * @param orientation 列表方向
     */
    public RecycleViewLineDivider(Context context, int orientation) {
     ...
     */
    public RecycleViewLineDivider(int orientation, int dividerHeight, int dividerColor) {
        if (orientation != LinearLayoutManager.VERTICAL && orientation != LinearLayoutManager.HORIZONTAL) {
            throw new IllegalArgumentException("请输入正确的参数！");
        }
        mOrientation = orientation;
     ...
     * @param dividerColor 分割线颜色
     */
    public RecycleViewLineDivider(int orientation, int dividerColor) {
